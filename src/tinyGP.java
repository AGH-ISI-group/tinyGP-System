...
public class tinyGP {
    ...
    //my own method
    int save_best_indiv_to_csv(char []buffer, int buffercounter) {
        ...
        try {
            ...
            int k = save_best_indiv(buffer, buffercounter, writer);
    ...
    //my own method
    int save_best_indiv(char []buffer, int buffercounter, BufferedWriter writer ) throws IOException {
        int a1=0, a2;
        ...
        switch(buffer[buffercounter]) {
            case ADD: writer.write( "(");
                ...
                writer.write( " + ");
                break;
            case SUB: writer.write( "(");
                a1= save_best_indiv( buffer, ++buffercounter, writer );
                writer.write( " - ");
                break;
            case MUL: writer.write( "(");
                a1= save_best_indiv( buffer, ++buffercounter, writer );
                writer.write( " * ");
                break;
        ...
        a2= save_best_indiv( buffer, a1, writer );
        writer.write( ")");
        return( a2);
    }
    ...
    void stats( double [] fitness, char [][] pop, int gen ) {
        ...
        save_best_indiv_to_csv(pop[best], 0); //my own code
        saveStats(gen + ";" + (-favgpop) + ";" + (-fbestpop)); //my own code
    }
